...
interface Membro  { nome: string; especialidade: string; cro: string; }
...
const EQUIPE: Membro[] = [
  { nome: 'Dra. Helena Rocha',   especialidade: 'Implantodontia',   cro: 'CRO-SP 54.210' },
  { nome: 'Dr. Marcelo Tavares', especialidade: 'Ortodontia',       cro: 'CRO-SP 61.882' },
  { nome: 'Dra. Beatriz Lemos',  especialidade: 'Odontopediatria',  cro: 'CRO-SP 72.045' },
  { nome: 'Dr. André Sampaio',   especialidade: 'Endodontia',       cro: 'CRO-SP 49.317' },
];
